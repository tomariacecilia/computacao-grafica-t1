/* Classes contendo a definição de objetos gráficos e classes básicas como cor e vetor 3d */
    ...
    class Rectangle{
        constructor (altura,largura,centro,color){
            this.altura = altura;
    ...
    class Linha extends Shape2d{
        constructor(p0,p1,color,interpolation){
            super(color);
            this.p0 = p0;
            this.p1 = p1;
    ...
    class Elipse extends Shape2d {
        constructor(cx, cy, height, width, numSubdiv, color) {
            super(color);
            this.cx = cx;
            this.cy = cy;
            this.height = height;
        ...
        evaluate(ang) {
            var x, y;
            x = this.width * Math.cos(ang) + this.cx;
            y = this.height * Math.sin(ang) + this.cy;
            return [x, y];
        }
